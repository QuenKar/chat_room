...
PBindName::PBindName()
  ...
  ::google::protobuf::internal::InitSCC(
      &protobuf_Protocol_2eproto::scc_info_PBindName.base);
  SharedCtor();
...
const PBindName& PBindName::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_Protocol_2eproto::scc_info_PBindName.base);
...
PChat::PChat()
  : ::google::protobuf::Message(), _internal_metadata_(NULL) {
  ::google::protobuf::internal::InitSCC(
      &protobuf_Protocol_2eproto::scc_info_PChat.base);
  SharedCtor();
...
const PChat& PChat::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_Protocol_2eproto::scc_info_PChat.base);
  return *internal_default_instance();
}
...
PRoomInformation::PRoomInformation()
  : ::google::protobuf::Message(), _internal_metadata_(NULL) {
  ::google::protobuf::internal::InitSCC(
      &protobuf_Protocol_2eproto::scc_info_PRoomInformation.base);
  SharedCtor();
...
const PRoomInformation& PRoomInformation::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_Protocol_2eproto::scc_info_PRoomInformation.base);
  return *internal_default_instance();
}
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::PBindName* Arena::CreateMaybeMessage< ::PBindName >(Arena* arena) {
  return Arena::CreateInternal< ::PBindName >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::PChat* Arena::CreateMaybeMessage< ::PChat >(Arena* arena) {
  return Arena::CreateInternal< ::PChat >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::PRoomInformation* Arena::CreateMaybeMessage< ::PRoomInformation >(Arena* arena) {
